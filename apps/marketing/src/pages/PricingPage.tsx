      ...
      <section className="pt-20 pb-24 px-4 max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            SettleOne charges a small fee only when a deal successfully settles.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="border border-[var(--border)] rounded-2xl p-8 shadow-sm">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center gap-3 text-gray-700">
                <Check className="text-green-500" size={20} /> Zero creation
                fees
              </li>
              <li className="flex items-center gap-3 text-gray-700">
                <Check className="text-green-500" size={20} /> Access to yield
                generation
              </li>
              <li className="flex items-center gap-3 text-gray-700">
                <Check className="text-green-500" size={20} /> Custom verifiable
                rules
              </li>
            </ul>
          ...
          <div className="border-2 border-[var(--accent-blue)] rounded-2xl p-8 shadow-md relative bg-blue-50/30">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-center gap-3 text-gray-700">
                <Check className="text-blue-500" size={20} /> Applied only if
                escalated
              </li>
              <li className="flex items-center gap-3 text-gray-700">
                <Check className="text-blue-500" size={20} /> Full evidence
                review
              </li>
              <li className="flex items-center gap-3 text-gray-700">
                <Check className="text-blue-500" size={20} /> Enforceable
                on-chain payout
              </li>
            </ul>
