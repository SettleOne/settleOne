...
import { Clock, Calendar, Zap, Copy, Lock, Globe } from "lucide-react";
...
export function DealCard({ deal, onClick }: { deal: any; onClick: () => void }) {
  ...
  border border-[var(--border)]">
      ...
      <p className="text-xs text-[var(--text-muted)] font-mono mb-3 flex items-center gap-2">
      ...
      <div className="mb-3">
        ...
        <span className="text-sm text-[var(--text-muted)] ml-1 font-semibold">
          {tokenSymbol}
        </span>
