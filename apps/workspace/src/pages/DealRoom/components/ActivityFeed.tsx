...
export function ActivityFeed() {
  const events = [
    ...
    },
    {
      ...
      title: 'Deal Funded',
      desc: 'Buyer deposited 5,000 USDC into the Vault.',
      time: '09:15 AM',
      date: 'Jan 5, 2026',
      txHash: '0xabc...def'
    },
    {
      ...
      title: 'Deal Created',
      desc: 'Smart Contract Audit deal initialized.',
      time: '14:30 PM',
      date: 'Jan 1, 2026',
      txHash: '0x123...456'
    }
  ...
  return (
    <div className="bg-white border border-[var(--border)] rounded-lg shadow-sm overflow-hidden mb-6 h-full flex flex-col">
      <div className="px-4 py-3 border-b border-[var(--border)] bg-gray-50 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] uppercase text-gray-400 font-bold tracking-wider">Live</span>
        </div>
      </div>
        ...
        <div className="relative border-l border-gray-200 ml-3 space-y-6 pb-4">
          ...
          {events.map((event) => (
            <div key={event.id} className="relative pl-6">
              <div className={`absolute -left-[11px] top-0.5 w-[22px] h-[22px] rounded-full flex items-center justify-center border-2 border-white shadow-sm ${event.color}`}>
                {event.icon}
              </div>
