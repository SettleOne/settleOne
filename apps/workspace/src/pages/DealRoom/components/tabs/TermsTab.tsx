    ...
    <div className="space-y-6">
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6 shadow-sm">
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="bg-[var(--bg-subtle)] p-4 rounded-lg text-sm text-[var(--text-primary)] whitespace-pre-wrap">
              {deal?.metadata?.sellerSpecifications ||
                deal?.sellerSpecifications ||
          ...
          <div>
            ...
            <div className="bg-[var(--bg-subtle)] p-4 rounded-lg text-sm text-[var(--text-primary)] whitespace-pre-wrap">
              {deal?.metadata?.evidenceRequirements ||
                deal?.evidenceRequirements ||
          ...
          <div>
            ...
            <div className="bg-[var(--bg-subtle)] p-4 rounded-lg text-sm text-[var(--text-primary)] whitespace-pre-wrap">
              {deal?.metadata?.settlementRules ||
                deal?.settlementRules ||
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-xl p-6 shadow-sm">
        ...
        <p className="text-sm text-[var(--text-secondary)] mb-4">
          These hashes represent the immutable state of the deal terms committed
          to the blockchain.
        </p>
        <div className="bg-[var(--bg-base)] border border-[var(--border)] rounded-lg px-4">
          ...
          <HashRow
            label="Evidence Requirements Hash"
            hash={deal?.evidenceRequirementsHash}
          />
          <HashRow
            label="Settlement Rules Hash"
            hash={deal?.settlementRulesHash}
          />
