    ...
    <Modal isOpen={isOpen} onClose={onClose} title="Fund Deal" size="md">
      {isFundSuccess ? (
        <div className="text-center py-8">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Deal Funded!</h2>
          ...
          <div className="bg-blue-50 p-4 rounded-md border border-blue-100 flex gap-3">
            ...
            <div className="text-sm text-blue-900">
              ...
              <p>
                ...
                {tokenSymbol} to activate this deal. Funds will be held securely
                in the Escrow Vault and begin earning yield.
              </p>
            </div>
          </div>
