      ...
      <div className="space-y-6">
        <div className="bg-red-50 p-4 rounded-md border border-red-100 flex gap-3 text-red-900">
          ...
          <div className="text-sm">
            ...
            <p>
              Opening a dispute pauses the deal and escalates it to the selected
              Dispute Resolver. This process may take time and could involve
              resolution fees.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-2">
            Upload screenshots, logs, or any other proof to support your claim.
          </p>
          <FileUploadZone
