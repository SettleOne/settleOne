    ...
    <div className="max-w-6xl mx-auto p-6 flex flex-col md:flex-row gap-8 text-[var(--text-primary)] font-[var(--font-sans)]">
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-[var(--radius-card)] shadow-[var(--shadow-card)] overflow-hidden">
          ...
          <div className="pt-14 px-6 pb-6">
            <h2 className="text-xl font-bold flex items-center gap-2">
              John Doe <CheckCircle size={16} className="text-[var(--accent-blue)]" />
            </h2>
            <p className="text-[var(--text-secondary)] text-sm mb-4">john@example.com</p>
            ...
            <div>
              ...
              <div className="w-full bg-[var(--bg-base)] rounded-full h-2">
                <div className="bg-[var(--accent-blue)] h-2 rounded-full" style={{ width: "80%" }}></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="flex-1">
        <div className="mb-6 flex gap-2 border-b border-[var(--border)] overflow-x-auto scrollbar-hide">
          {[
            { id: "created", label: "Created Deals", icon: Briefcase },
            { id: "accepted", label: "Accepted Deals", icon: CheckCircle },
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border)] rounded-[var(--radius-card)] p-6 shadow-[var(--shadow-card)] min-h-[400px]">
          {activeTab === "created" && (
            <div>
              <h3 className="text-xl font-bold mb-4">Deals You Created</h3>
              <div className="text-[var(--text-secondary)] italic text-sm text-center py-12 bg-[var(--bg-base)] rounded-[var(--radius-card)] border border-dashed border-[var(--border)]">
                Grid of created deal cards goes here.
              </div>
            </div>
          )}
          ...
          {activeTab === "accepted" && (
            <div>
              <h3 className="text-xl font-bold mb-4">Deals You Accepted</h3>
              <div className="text-[var(--text-secondary)] italic text-sm text-center py-12 bg-[var(--bg-base)] rounded-[var(--radius-card)] border border-dashed border-[var(--border)]">
                Grid of accepted deal cards goes here.
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input type="text" defaultValue="John Doe" className="bg-[var(--bg-base)] border-[var(--border)] text-[var(--text-primary)]" />
                </div>
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input type="email" defaultValue="john@example.com" className="pl-9 bg-[var(--bg-base)] border-[var(--border)] text-[var(--text-primary)]" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2 text-[var(--text-secondary)]">Phone Number</label>
                  <Input type="tel" placeholder="+1 (555) 000-0000" className="bg-[var(--bg-base)] border-[var(--border)] text-[var(--text-primary)]" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2 text-[var(--text-secondary)]">Organization / Company</label>
                  <div className="relative">
                    <Building className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--text-muted)]" size={16} />
                    <Input type="text" defaultValue="DeFi Labs Inc." className="pl-9 bg-[var(--bg-base)] border-[var(--border)] text-[var(--text-primary)]" />
                  </div>
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2 text-[var(--text-secondary)]">Business Location / Region</label>
                  <Input type="text" defaultValue="San Francisco, CA" className="bg-[var(--bg-base)] border-[var(--border)] text-[var(--text-primary)]" />
                </div>
                <div>
                  <label className="block text-sm font-medium mb-2 text-[var(--text-secondary)]">Time Zone</label>
              ...
              <div>
                ...
                <div className="space-y-4 max-w-md">
                  <div>
                    ...
                    <Input type="password" placeholder="••••••••" className="bg-[var(--bg-base)] border-[var(--border)] text-[var(--text-primary)]" />
                  </div>
                  <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-4 bg-[var(--bg-base)] border border-[var(--border)] rounded-[var(--radius-input)]">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-[var(--text-secondary)]">San Francisco, CA • Current Session</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-[var(--bg-base)] border border-[var(--border)] rounded-[var(--radius-input)]">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-sm">iPhone 14 • Safari</p>
                        <p className="text-xs text-[var(--text-secondary)]">New York, NY • Last seen 2h ago</p>
                      </div>
                    </div>
