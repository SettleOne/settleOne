...
import { 
  LayoutGrid, PieChart, Inbox, 
  Activity, PlusSquare, CheckSquare, 
  Paperclip, UploadCloud, Settings, HelpCircle 
} from 'lucide-react';
      ...
      <div className="flex-1 py-4 px-3 space-y-6">
        ...
        <div>
          ...
          <div className="space-y-1">
            <NavItem to="/marketplace" icon={<LayoutGrid />} label="Marketplace" isActive={currentPath.startsWith('/marketplace')} />
            <NavItem to="/portfolio" icon={<PieChart />} label="Portfolio" isActive={currentPath === '/portfolio'} />
            <NavItem to="/inbox" icon={<Inbox />} label="Inbox" badge={3} isActive={currentPath === '/inbox'} />
          </div>
        </div>

        {/* MY DEALS */}
        <div>
          <h3 className="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">My Deals</h3>
          <div className="space-y-1">
            <NavItem to="/deals/active" icon={<Activity />} label="Active Deals" badge={2} isActive={currentPath === '/deals/active'} />
            <NavItem to="/deals/created" icon={<PlusSquare />} label="Created Deals" isActive={currentPath === '/deals/created'} />
            <NavItem to="/deals/accepted" icon={<CheckSquare />} label="Accepted Deals" isActive={currentPath === '/deals/accepted'} />
          </div>
        </div>
        ...
        {/* ACCOUNT */}
        <div>
          <h3 className="px-3 text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2">Account</h3>
          <div className="space-y-1">
            <NavItem to="/settings" icon={<Settings />} label="Settings" isActive={currentPath === '/settings'} />
            <a href="https://docs.settleone.xyz" target="_blank" rel="noreferrer" className="flex items-center gap-3 px-3 py-2 rounded-md text-[var(--text-secondary)] hover:bg-gray-50 hover:text-[var(--text-primary)] transition-colors">
              <HelpCircle size={18} />
      ...
      <div className="p-4 border-t border-[var(--border)]">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex flex-col">
            <span className="text-sm font-semibold text-[var(--text-primary)]">John Doe</span>
