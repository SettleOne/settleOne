      ...
      <div className="flex-1 max-w-xl px-4 hidden md:block">
        ...
        >
          ...
          <div className="ml-auto flex items-center gap-1">
            <kbd className="px-1.5 py-0.5 text-xs font-mono bg-white border border-[var(--border)] rounded">⌘</kbd>
            <kbd className="px-1.5 py-0.5 text-xs font-mono bg-white border border-[var(--border)] rounded">K</kbd>
          </div>
        </button>
      </div>
