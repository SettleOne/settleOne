    ...
    <div className="min-h-screen bg-[var(--bg-base)]">
      <nav className="bg-white border-b border-[var(--border)] px-6 py-4 flex items-center gap-8">
        ...
        <div className="flex gap-4 text-sm font-medium">
          ...
          <a href="/disputes" className="text-gray-600 hover:text-gray-900">
            Disputes
          </a>
          <a href="/protocol" className="text-gray-600 hover:text-gray-900">
            Protocol Config
          </a>
        </div>
      </nav>
      <main>{children || <React.Fragment />}</main>
    </div>
  );
}
