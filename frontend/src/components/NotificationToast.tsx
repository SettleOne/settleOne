        ...
        {toasts.map((toast) => (
          ...
          >
            <div className={cn(
              ...
              toast.type === 'protocol' ? "border-brand-teal/30 shadow-[0_0_20px_rgba(0,229,160,0.1)]" : "border-text-muted/10"
            )}>
              ...
              <div className={cn(
                ...
                toast.type === 'protocol' ? "bg-brand-teal/20 text-brand-teal" : "bg-bg-tertiary text-text-slate"
              )}>
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-text-slate leading-relaxed">{toast.message}</p>
              </div>
