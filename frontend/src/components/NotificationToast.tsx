...
export function NotificationToast() {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case "warning": return <Zap className="w-5 h-5 text-brand-gold" />;
        ...
        {activeNotifications.map((n) => (
          <motion.div
            ...
            className={cn(
              ...
              n.type === "success" ? "border-l-brand-teal" : 
              n.type === "warning" ? "border-l-brand-gold" : 
              n.type === "error" ? "border-l-red-500" : "border-l-brand-teal"
            )}
          >
