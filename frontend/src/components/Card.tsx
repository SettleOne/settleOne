...
export function CardTitle({ className, ...props }: React.HTMLAttributes<HTMLHeadingElement>) {
  return (
    <h3
      className={cn("font-syne font-bold text-xl leading-none tracking-tight text-text-primary", className)}
      {...props}
    />
  )
}
...
export function CardDescription({ className, ...props }: React.HTMLAttributes<HTMLParagraphElement>) {
  return (
    <p
      className={cn("text-xs text-text-slate font-mono uppercase tracking-[0.2em]", className)}
      {...props}
    />
  )
}
...
export function CardFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn("flex items-center p-6 pt-0 border-t border-text-muted/5 mt-auto relative z-10", className)}
      {...props}
    />
  )
}
