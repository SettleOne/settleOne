    ...
    <div className="w-full">
      ...
      {files.length > 0 && (
        <div className="mt-4 space-y-2">
          {files.map((file, i) => (
            <div key={i} className="flex items-center justify-between p-3 bg-white border border-[var(--border)] rounded-md shadow-sm">
              <div className="flex items-center space-x-3 overflow-hidden">
                <FileIcon size={16} className="flex-shrink-0 text-[var(--text-secondary)]" />
